var Search = (props) => (
  <div className="search-bar form-inline">
    ...
    <input className="form-control" type="text" placeholder="Search YouTube" value={props.searchValue} onChange={event => props.onType(event)} onKeyPress={event => props.onEnter(event)}/>
